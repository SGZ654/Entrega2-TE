...
//components
import TeacherActions from 'pages/teachers/components/TeacherActions';
...
const rows = [
  createData(1234567890, 'Juliana', 'Pérez Solis', 'Calle 10 # 25-16, Barrio San José, Bogotá', 32),
  createData(2345678901, 'Luisa Fernada', 'Ortiz Cruz', 'Avenida 5 # 14-78, Conjunto Residencial Las Acacias, Medellín', 27),
